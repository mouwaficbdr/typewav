...
/**
 * LegacyLearningMode : implémentation pré-curriculum du mode d'apprentissage
 * Home Row avec niveaux progressifs (QWERTY et ancienne approche AZERTY).
 * `LearningMode` délègue ici tant que la bifurcation par disposition clavier
 * n'est pas en place ; ce fichier sera retiré quand le curriculum QWERTY
 * sera livré.
 *
...
export function LegacyLearningMode({
  isOnboarding = false,
  onExitTutorial,
}: LearningModeProps) {
